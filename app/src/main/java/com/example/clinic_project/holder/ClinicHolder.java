...
public class ClinicHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ClinicHolder(View itemView, ClinicHolder.OnClinicClickListener listener) {
        super(itemView);this.listener = this.listener;
        initView(itemView);
    ...
    public static ClinicHolder create(LayoutInflater inflater, ViewGroup viewGroup, ClinicHolder.OnClinicClickListener listener) {
