...
public class DragDetailActivity extends AppCompatActivity implements ExaminationPhoneNumberHolder.OnItemClickListener{
    ...
    private void getDragDetail() {
        Log.e("getExaminationDetail","success");
        Api dragDetailApi = service.getRetrofitService().create(Api.class);
        dragDetailApi.getOtherServiceDetail(token,type,serviceId).enqueue(new Callback<OtherServiceDetailResponse>() {
            @Override
            public void onResponse(Call<OtherServiceDetailResponse> call, Response<OtherServiceDetailResponse> response) {
                if(response.isSuccessful()){
                    if(response.body().isSuccess) {
                        ...
                        Log.e("phoneNumberdataSize", String.valueOf(phoneNumbers.size()));
                        tvname.setText(response.body().otherServiceDetail.name);
                        tvtown.setText(String.valueOf(response.body().otherServiceDetail.townName));
                        tvaddress.setText(String.valueOf(response.body().otherServiceDetail.address));
    ...
    public void onDragPhoneNumberClick(View view) {
