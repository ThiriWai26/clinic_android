...
public class RegistrationDetailActivity extends AppCompatActivity implements ExaminationPhoneNumberHolder.OnItemClickListener {
    ...
    public void onRegistrationPhoneNumberClick(View view) {
